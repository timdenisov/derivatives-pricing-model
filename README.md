...
Для загрузки исторических котировок финансовых активов рекомендуется использовать данные с сайта FINAM:

https://www.finam.ru/profile/moex-akcii/gazprom/export/

Файлы необходимо сохранить в формате FINAM или привести к соответствующей структуре.
...
Historical market data can be downloaded from:
