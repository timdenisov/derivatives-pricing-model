...
Небольшая платформа для оценки деривативов, которую я сделал как курсовой проект с уклоном в quant.
...
* реализовывать модели ценообразования
* использовать численные методы
* подключаться к рыночным данным
